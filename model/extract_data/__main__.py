...
def main(ticker_list, form_list):
    ...
    df_merged_idx = (
        pq.read_table(CONFIG.MERGED_IDX_FILEPATH)
        .to_pandas()
    ...
    if form_list:
        ...
        df_merged_idx = df_merged_idx[
            df_merged_idx["Form Type"].isin(CONFIG.forms_list)
        ]
    ...
    df_filings = df_merged_idx.assign(
        url=df_merged_idx["Filename"].apply(
